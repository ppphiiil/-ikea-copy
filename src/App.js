...
import DropdownRadio from './components/DropdownRadio/DropdownRadio.js';
  ...
  return (
    <MyContext.Provider value={ { sort, setSort } }>
      <div className="App">
        ...
        <div onClick={ closeSideMenu } className="overlay-menu"></div>
        <div onClick={ closeFilterMenu } className="overlay-filter"></div>
        <div className="filter__main">
          <DropdownRadio style={ { paddingRight: "10px" } } name="filter-sort" title="Sort by" items={ itemsForFilterSort } />
          <FilterButton style={ { paddingRight: "10px" } } name="filter-all" title="All Filters" iconUrl="../../icons/equalizer.png" btnLink={ openAllFilters } />
